...
namespace ClientApp.RemoteServerRef {
    ...
    public interface IServer {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServer/GetTasksBetweenDates", ReplyAction="http://tempuri.org/IServer/GetTasksBetweenDatesResponse")]
        System.Collections.Generic.List<ClientApp.RemoteServerRef.BaseCalendarEntry> GetTasksBetweenDates(System.DateTime from, System.DateTime to);
    }
    ...
    public partial class ServerClient : System.ServiceModel.ClientBase<ClientApp.RemoteServerRef.IServer>, ClientApp.RemoteServerRef.IServer {
        ...
        public System.Collections.Generic.List<ClientApp.RemoteServerRef.BaseCalendarEntry> GetTasksBetweenDates(System.DateTime from, System.DateTime to) {
            return base.Channel.GetTasksBetweenDates(from, to);
        }
    }
}
